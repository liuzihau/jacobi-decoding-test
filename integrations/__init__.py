...
if TYPE_CHECKING:
    from integrations.aqlm import replace_with_aqlm_linear
    ...
    from integrations.bitnet import (
        BitLinear,
        pack_weights,
        replace_with_bitnet_linear,
        unpack_weights,
    )
    from integrations.bitsandbytes import (
        dequantize_and_replace,
        get_keys_to_not_convert,
        replace_8bit_linear,
        replace_with_bnb_linear,
    ...
    from integrations.eetq import replace_with_eetq_linear
    from integrations.fbgemm_fp8 import FbgemmFp8Linear, replace_with_fbgemm_fp8_linear
    ...
    from integrations.hqq import prepare_for_hqq_linear
    ...
    from integrations.peft import PeftAdapterMixin
    from integrations.quanto import replace_with_quanto_layers
